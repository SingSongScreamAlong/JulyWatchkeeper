...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Reload to initialize WebSocket
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">WATCHKEEPER</h1>
          <p className="text-blue-100">Missionary Intelligence & Safety Platform</p>
        </div>
          ...
          <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="flex items-start">
              ...
              <div className="text-sm text-yellow-800">
                ...
                <p className="mt-2 text-xs">⚠️ Change these immediately after first login!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-center text-white text-sm">
          <p>WATCHKEEPER v2.0 - Protecting missionaries worldwide</p>
          <p className="mt-2 text-blue-200">
            Need help? Contact <a href="mailto:support@watchkeeper.org" className="underline">support@watchkeeper.org</a>
          </p>
        </div>
      </div>
    </div>
